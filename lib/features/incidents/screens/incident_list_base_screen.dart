...
return SingleChildScrollView(
  ...
  child: Column(
    children: [
      ...
      StreamBuilder<List<IncidentItem>>(
        key: ValueKey(
          'incident-list-${widget.onlyCurrentUser}-$uid-$_refreshVersion',
        ),
        stream: _getIncidentsStream(uid),
...
//                     if (index == 2) {
//                       return _buildSearchBox(fontSize);
//                     }

//                     if (index == 3) {
//                       return _buildFilterCard(fontSize);
//                     }

//                     final incident = incidents[index - 4];
...
//       child: Row(
//         children: [
//           Icon(icon, color: _primaryGreenDark),
...
//                 Text(
//                   subtitle,
//                   style: AppTextStyles.regular(fontSize * 0.85),
//                 ),
//               ],
//             ),
//           ),
...
//   Widget _buildFilterCard(double fontSize) {
//     return _buildFilterDropdown(fontSize);
//   }

//   Widget _buildFilterDropdown(double fontSize) {
//     return DropdownButton<IncidentListFilter>(
...
//         });
//       },
//       items: IncidentListFilter.values.map((filter) {
